...
const ChildishCategory = ({
  ...
  const [allSpansBrands2] = useState<string[]>([
    'Stitch',
    'Minnie',
    'Hello Kitty',
    'Homem',
    ...
    <Styled.ContainerModalFloating
      ...
      <div className="flex h-full justify-between">
        ...
        <div className="flex justify-end w-[353px] h-[400px]">
          <div className="flex">
            <img
              src="https://images2.marisa.com.br/medias/sys_master/images/images/had/h69/16651790155806/BMenu-Infantil-20250318-Infantil-Desktop.gif"
              alt="img-bottom"
            />
          </div>
        </div>
...
export default ChildishCategory;
