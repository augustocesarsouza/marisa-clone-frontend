...
const SecuritySealsPaymentMethods = () => {
  return (
    <Styled.ContainerMain>
      <Styled.ContainerSecuritySeals>
        <Styled.ContainerSecuritySealsSvgAndSpan>
          <Styled.Img
            src="https://res.cloudinary.com/dyqsqg7pk/image/upload/q_100/v1741713532/imgs-backend-frontend-marisa/frontend/lock_te7w3c.webp"
            alt="img-lock"
          />
          <Styled.Span>Selos de segurança</Styled.Span>
        </Styled.ContainerSecuritySealsSvgAndSpan>
...
export default SecuritySealsPaymentMethods;
